...
function heatmapChartTag(hexo, args = [], content = '') {
    ...
    const [theme = 'oceanic', inputYear, footerArg] = args.map(arg => (arg ? arg.trim() : ''));
    ...
    // Use the specified theme or default to 'oceanic'
    const colors = themes[theme.toLowerCase()] || themes.oceanic;
                ...
                if (heatmapChartDom) {
                    ...
                    const chartOptions = {
                        ...
                        visualMap: {
                            ...
                            inRange: { color: ${JSON.stringify(colors)} },
                        },
                        legend: {
                            type: 'scroll',
                            icon: 'none',
